...
public:
    ...
    int get_right_height();         //return height of the right son
    int get_left_height();          //return height of the left son
...
template <class K, class D>
TreeNode<K,D>::TreeNode(const K& key, const D& data) : key(key), data(data),
                                                       height(0),
                                                       left_son(nullptr),
                                                       right_son(nullptr){
}
